...
data_folder=generated_data/sft_demonstrations/vwxyzjn_EleutherAI_pythia-6.9b-deduped__ppo_left_padding_new_nowhiten_reward__tldr/train_dataset
SFT_MODEL_PATH=models/$MODEL/reference_trained_sft_$SEED
